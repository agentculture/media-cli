"""``media-cli learn`` — the learnability affordance.
...
_TEXT = """\
media-cli — a clonable template for AgentCulture mesh agents.
...
Commands
--------
  media-cli whoami             Identity from culture.yaml.
  media-cli learn              This self-teaching prompt.
  media-cli explain <path>...  Markdown docs for any noun/verb path.
  media-cli overview           Descriptive snapshot of the agent.
  media-cli doctor             Check the agent-identity invariants.
  media-cli cli overview       Describe the CLI surface itself.
...
def _as_json_payload() -> dict[str, object]:
    return {
        ...
        "json_support": True,
        "explain_pointer": "media-cli explain <path>",
    }
