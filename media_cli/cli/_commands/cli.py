"""``media-cli cli`` — noun grouping CLI-surface introspection.
...
from media_cli.cli._commands.overview import cli_sections, emit_overview
...
def _no_verb(args: argparse.Namespace) -> int:
    # `media-cli cli` with no sub-verb prints the noun's overview.
...
def register(sub: argparse._SubParsersAction) -> None:
    ...
    ov = noun_sub.add_parser("overview", help="Describe the media-cli CLI surface.")
