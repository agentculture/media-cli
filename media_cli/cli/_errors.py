...
Every failure inside media-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`media_cli.cli._output`,
...
# Exit-code policy. Documented in ``media-cli learn`` output.
# 0      = success
