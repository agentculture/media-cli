...
uv run media-cli whoami  # identity from culture.yaml
uv run media-cli learn   # self-teaching prompt (add --json)
...
1. Rename the package `media_cli/` and the `media-cli`
